...
namespace XLua.CSObjectWrap
{
    ...
    public class QSPlayerControlPlayerControlsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(QS.PlayerControl.PlayerControls);
			Utils.BeginObjectRegister(type, L, translator, 0, 7, 12, 2);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "MainUI", _g_get_MainUI);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "DialoguePanel", _g_get_DialoguePanel);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Inventory", _g_get_Inventory);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Inventory_Weapon", _g_get_Inventory_Weapon);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Inventory_Prop", _g_get_Inventory_Prop);
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "Inventory_Note", _g_get_Inventory_Note);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new QS.PlayerControl.PlayerControls();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to QS.PlayerControl.PlayerControls constructor!");
        ...
        static int _m_Dispose(RealStatePtr L)
        {
		    try {
                ...
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
        ...
        static int _m_FindAction(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to QS.PlayerControl.PlayerControls.FindAction!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_MainUI(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.MainUI);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_DialoguePanel(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.DialoguePanel);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Inventory(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Inventory);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Inventory_Weapon(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Inventory_Weapon);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Inventory_Prop(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Inventory_Prop);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_Inventory_Note(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                QS.PlayerControl.PlayerControls gen_to_be_invoked = (QS.PlayerControl.PlayerControls)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.Inventory_Note);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
