...
namespace QS.Impl.Service
{
    ...
    class PlayerControllService : IPlayerControllService
    {
        ...
        readonly Relay<ICharacterTranslation> tRelay;
        public PlayerControllService()
        {
            tRelay = Relay<ICharacterTranslation>
                     .Tick(() => GetTranslation(), out tMotion);
 
           var life = ControlGlobal.Instance.DI.GetInstance<ILifecycleProivder>();
            life.Request(Lifecycles.Update, () => tMotion.Set());
        }
        public Relay<ICharacterTranslation> GetPlayerTranslation()
        {
          return tRelay;
        }
        ...
        public ICharacterTranslation GetTranslation()
        {
